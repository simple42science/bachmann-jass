...
- Korrektur (16.09.2026): Im Slalom wechselt nur noch die Rangfolge von Stich zu Stich; die Kartenwerte bleiben die der angesagten Richtung. Damit ergibt eine Runde in jeder Spielart 157 Punkte (vorher je nach Verteilung bis 179). Das Slalom-Fixture der Web-App ist deshalb entfernt.
...
- Bestätigt (16.09.2026): Der Bieter beginnt die Partie – er sagt in der ersten Runde die Spielart an und spielt die erste Karte aus. Im Schieber ist im allerersten Spiel der Halter der Rosen 7 Vorhand, sagt an und spielt aus (war schon so, über 200 Seeds geprüft).
